	...
	protected void handleMessageFromClient(Object msg, ConnectionToClient client) {
		try {
			if (msg instanceof Message) {
				...
				uiLogger.accept("> Received command: " + request.getCommand() + " from "
				...
				// =========================================================================
					...
					uiLogger.accept(
							"> Park Manager requested parameter change. Sending to Dept Manager for approval.\n");

					boolean success = DBController.submitParameterRequest(requestedUpdate);

					if (success) {
						client.sendToClient(new Message("UPDATE_PARAMS_SUCCESS",
								"Request forwarded to Department Manager for approval."));
					} else {
